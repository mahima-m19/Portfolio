      ...
      <div className="relative max-w-5xl w-full z-10">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8 sm:mb-12">
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 sm:px-5 py-2 sm:py-2.5 bg-[var(--accent-color)] text-[var(--button-text)] rounded-full text-sm font-medium hover:opacity-90 transition-all duration-300 shadow-lg whitespace-nowrap"
          >
            <Download size={18} />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 lg:gap-12">
          <div>
            ...
            <div className="flex items-center gap-3 mb-6">
              <GraduationCap
                size={20}
                className="text-[var(--accent-color)] sm:w-[22px] sm:h-[22px]"
              />
              <h2 className="text-xl sm:text-2xl font-bold">Education</h2>
            </div>
            <div className="ml-6 sm:ml-8 space-y-6 sm:space-y-8 relative">
              {/* Vertical Timeline Line */}
              <div className="absolute left-[5px] top-6 bottom-0 w-0.5 bg-[var(--border-color)]"></div>

              {/* BCA */}
              <div className="flex items-start gap-3 sm:gap-4 relative">
                <div className="w-3 h-3 rounded-full bg-[var(--accent-color)] mt-1.5 flex-shrink-0 relative z-10"></div>
                <div className="flex-1">
                  ...
                  {/* Date */}
                  <div className="flex items-center gap-2 text-xs sm:text-sm text-[var(--text-secondary)] mb-2">
                    <Calendar size={14} />
                    <span>2022 - 2025</span>
                  </div>
          ...
          <div>
            ...
            {/* Experience Item */}
            <div className="ml-6 sm:ml-8 space-y-4 relative">
              {/* Vertical Line */}
              <div className="absolute left-[5px] top-6 bottom-0 w-0.5 bg-[var(--border-color)]"></div>
              ...
              <div className="flex items-start gap-3 sm:gap-4 relative">
                ...
                <div className="flex-1">
                  ...
                  {/* Company */}
                  <div className="flex items-center gap-2 text-xs sm:text-sm text-[var(--text-secondary)] mb-4">
                    <Building2 size={14} />
                    <span>On-Site</span>
                  </div>
                  ...
                  <ul className="space-y-2">
                    <li className="flex items-start gap-2 text-xs sm:text-sm text-[var(--text-secondary)] leading-relaxed">
